...
In deze taak gaan we **Visual Studio Code** installeren. [Visual Studio Code](https://en.wikipedia.org/wiki/Visual_Studio_Code) is de zogenaamde editor waarin je tijdens jouw opleiding programmeercode schrijft. 
